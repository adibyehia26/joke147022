...
using joke147022.Data;
using joke147022.Models;
using Microsoft.AspNetCore.Authorization;

namespace joke147022.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> searchResult(string searchWord)
        {
             return _context.Joke != null ?
                        View("Index",await _context.Joke.Where( row=> row.JokeQuestion.Contains(searchWord)).ToListAsync()) :
                        Problem("Entity set 'ApplicationDbContext.Joke'  is null.");
        }
        // GET: Jokes/Details/5
